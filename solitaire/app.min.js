...
function renderBoard() {
    try {
        ...
        if (showTutorial) {
            ...
            ctx.fillText('Click stock to draw, click cards to move.', 100 * scale, 240 * scale);
            ctx.fillText('Click anywhere to continue.', 100 * scale, 280 * scale);
        }
    } catch (e) {
        console.error('Render failed:', e);
        document.getElementById('debug').textContent = `Render Error: ${e.message}`;
    }
}
